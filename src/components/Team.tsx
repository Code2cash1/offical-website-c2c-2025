...
const team = [
  ...
  { name: 'Reshav Anand', role: 'Technical Lead & Full Stack Developer', image: reshav, social: { github: '#', linkedin: '#', twitter: '#' } },
  ...
  return (
    <div id='team' className="min-h-screen bg-black pt-32 pb-24">
      <div className="container mx-auto px-4">
        ...
        {/* Horizontal Scroll Layout for smaller screens */}
        <div className="flex overflow-x-auto space-x-4 py-4 md:hidden">
          {team.map((member, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 20 }}
              ...
              transition={{ duration: 0.8, delay: index * 0.1 }}
              whileHover={{ scale: 1.05 }}
              className="group relative flex-none w-72 hover:shadow-xl hover:shadow-white/50"
            >
